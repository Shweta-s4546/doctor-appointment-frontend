    ...
    const deleteHandler = async (id) => {
        try {
            if(window.confirm("are you sure to delete")){
              ...
              toast.warning(`service delete terminated`)
            }
        } catch (err) {
    ...
    <div className='container'>
      <div className="row">
        <div className="col-md-12 mt-5">
            <NavLink to={`/doctor/service/add`} className='btn btn-outline-success float-end'>Add services</NavLink>
        </div>
      </div>
      <div className="row">
        ...
        <div className="col-md-12">
          <div className="table table-responsive">
            <table className="table table-bordred table-striped table-hovered text-center">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Desc</th>
