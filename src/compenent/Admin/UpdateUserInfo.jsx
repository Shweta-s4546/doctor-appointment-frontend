                    ...
                    <div className="card-body">
                        <form autoComplete="off" onSubmit={submitHandler}>
                            <div className="form-group mt-2">
                                ...
                                <select name="role" id="role" className="form-select"  value={user.role} onChange={readValue} required>
                            ...
                            <div className="form-group mt-2">
                                ...
                                <select name="isActive" id="isActive" className="form-select" value={user.isActive} onChange={readValue} required>
