    ...
    return(
        <nav className="navbar navbar-expand-md navbar-dark bg-success">
            ...
            <button className='navbar-toggler' data-bs-toggle="collapse" data-bs-target="#menu">
                <spmn className="navbar-toggler-icon"></spmn>
            </button>
                                        ...
                                        }
                                         {
                                            isAdmin && token ?  (
                                                <React.Fragment>
                                                        ...
                                                        <li>
                                                            <NavLink to={`/admin/doctors/all`} className="dropdown-item">All Doctor</NavLink>
                                                        </li>
                                                        <li>
                                        ...
                                        }
                                        {
                                            isDoctor && token ?  (
                                                <React.Fragment>
                                                        ...
                                                        <li>
                                                            <NavLink to={`/doctor/service`} className="dropdown-item">Services</NavLink>
                                                        </li>
                                                        <li>
