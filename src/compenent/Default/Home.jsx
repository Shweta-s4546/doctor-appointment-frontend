    ...
    <section id="hero">
      <div className="container-fluid" id="home">
        <div className="row">
          <div className="col-md-6">
            ...
            <h3 className="display-1 text-white">Health <span className='text-secondary'>Care</span></h3>
                    ...
                    <form autoComplete='off'>
                      <div className="form-group mt-3">
                        <div className="input-group">
                            <input type="search" namae="location" id="location" className='form-control' placeholder='Service' required/>
      ...
      <div className="container">
          <div className="col-md-12 text-center mt-4 mb-4">
            <h3 className="display-3 text-succe">
              Services
            </h3>
          </div>
          <div className="row">
                        ...
                        <div className="card-body">
                          ...
                          <ul className="list-group">
                            <li className="list-group-item">
                              <strong className="text-success">Consultation_fee</strong>
